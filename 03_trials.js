...
var images_test = [];
for(i = 13; i<=15; i++) {
    images_test.push({name: ''+i+'_50_same.jpg', expected: 'same'});
    images_test.push({name: ''+i+'_50_different.jpg', expected: 'different'});
    images_test.push({name: ''+i+'_150_same.jpg', expected: 'same'});
    images_test.push({name: ''+i+'_150_different.jpg', expected: 'different'});
}
...
var images_main = [];
for(i = 1; i<=12; i++) {
    images_main.push({name: ''+i+'_50_same.jpg', expected: 'same'});
    images_main.push({name: ''+i+'_50_different.jpg', expected: 'different'});
    images_main.push({name: ''+i+'_150_same.jpg', expected: 'same'});
    images_main.push({name: ''+i+'_150_different.jpg', expected: 'different'});
}
